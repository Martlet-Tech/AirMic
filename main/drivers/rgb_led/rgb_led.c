...
void rgb_led_init(gpio_num_t pin)
{
    ...
    rmt_bytes_encoder_config_t encoder_config = {
        .bit0 = {
            .duration0 = WS2812B_T0H * 1000, // 0码高电平时间（us）
            .level0 = 1,
            .duration1 = WS2812B_T0L * 1000, // 0码低电平时间（us）
            .level1 = 0,
        },
        .bit1 = {
            .duration0 = WS2812B_T1H * 1000, // 1码高电平时间（us）
            .level0 = 1,
            .duration1 = WS2812B_T1L * 1000, // 1码低电平时间（us）
            .level1 = 0,
        },
        .flags = {
            .msb_first = true, // WS2812B使用MSB优先
        },
    };
